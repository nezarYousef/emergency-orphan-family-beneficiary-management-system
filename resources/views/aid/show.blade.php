@extends('layouts.app')
@section('content')
<div class="d-flex justify-content-between"><h1>Aid Distribution</h1>@can('edit-records')<a class="btn btn-outline-primary" href="/aid-distributions/{{ $distribution->id }}/edit">Edit</a>@endcan</div>
