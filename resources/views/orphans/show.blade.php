@extends('layouts.app')
@section('content')
<div class="d-flex justify-content-between"><h1>{{ $orphan->orphan_number }}</h1>@can('edit-records')<a class="btn btn-outline-primary" href="/orphans/{{ $orphan->id }}/edit">Edit</a>@endcan</div>
